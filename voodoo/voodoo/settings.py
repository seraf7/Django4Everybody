...
INSTALLED_APPS = [
    ...
    # Se agrega la nueva aplicación de encuestas
...
DATABASES = {
    'default': {
        ...
        'NAME': 'seraf7$basesita',
        'USER': 'seraf7',
        'PASSWORD': 'mysql123',
        'HOST': 'seraf7.mysql.pythonanywhere-services.com',
        'OPTIONS': {
...
try:
    ...
    print('When you want to use social login, please see voodoo/github_settings-dist.py')
